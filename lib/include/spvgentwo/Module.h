...
namespace spvgentwo
{
	...
	public:
		...
		void iterateInstructions(Func _func) { spvgentwo::iterateModuleInstructions(*this, _func); }

		template <class Func> // func takes const Instruction& -> func(instr)
		void iterateInstructions(Func _func) const { spvgentwo::iterateModuleInstructions(*this, _func); }
