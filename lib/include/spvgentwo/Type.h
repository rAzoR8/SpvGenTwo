...
#pragma endregion
	...
	public:
		...
		bool isScalarOrVectorOfSameLength(const spv::Op _type, const Type& _other) const { return hasSameVectorLength(_other, _type) || (m_Type == _type && _other.m_Type == _type && isScalar()); }
